...
type LedAndAlarmAndDac = (
    ...
    hal::timer::Alarm0,
    mcp4725::MCP4725<rp2040_hal::I2C<pac::i2c0::RegisterBlock, (rp2040_hal::gpio::Pin<rp2040_hal::gpio::bank0::Gpio26, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>, rp2040_hal::gpio::Pin<rp2040_hal::gpio::bank0::Gpio27, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>)>>,
    // mcp4725::MCP4725<rp2040_hal::I2C<I2C1, (rp2040_hal::gpio::Pin<rp2040_hal::gpio::bank0::Gpio26, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>, rp2040_hal::gpio::Pin<rp2040_hal::gpio::bank0::Gpio27, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>)>>, C17 AGAIN??? 
    // mcp4725::MCP4725<rp2040_hal::I2C<pac::i2c0::RegisterBlock, (rp2040_hal::gpio::Pin<Gpio26, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>, rp2040_hal::gpio::Pin<Gpio27, rp2040_hal::gpio::Function<rp2040_hal::gpio::I2C>>)>> c17.out
    // rp2040_hal::I2C<pac::i2c0::RegisterBlock, rp2040_hal::gpio::Pins>, c15.out
    // rp2040_hal::I2C<rp2040_pac::pio0::RegisterBlock, rp2040_hal::gpio::Pins>, c14.out
    // rp2040_hal::I2C<RegisterBlock, rp2040_hal::gpio::Pins>, c13.out
    // rp2040_hal::I2C<pac::RegisterBlock, rp2040_hal::gpio::Pins>, c12.out
    // rp2040_hal::I2C<rp2040_hal::i2c::I2CBlock, rp2040_hal::gpio::Pins>, c11.out
    // rp2040_hal::I2C<rp2040_hal::I2CBlock, rp2040_hal::gpio::Pins>, c10.out
    // rp2040_hal::I2C<rp2040_hal::i2c::Block, rp2040_hal::gpio::Pins>; c9.out
    // rp2040_hal::I2C<rp2040_hal::i2c, rp2040_hal::gpio::Pins>; c8.out
    // rp2040_hal::I2C<I2C,Pins>; c7.out
    // rp2040_hal::I2C; c6.out
    // I2C; c56.out
    // mcp4725::I2C; c5.out
    // MCP4725<rp2040_hal::i2c::I2C<I2C, rp2040_hal::gpio::Pins>, Mutex<RefCell<u8>>>, c4.out 
    // mcp4725<<rp2040_hal::i2c::I2C>, Mutex<RefCell<u8>>>, // dac component 
    // mcp4725<<rp2040_hal::i2c::I2C, rp2040_hal::gpio::Pins>,Mutex<RefCell<u8>>>, // dac component 
);
	   ...
	   let res = dac.set_dac(PowerDown::Normal, SIN_TABLE[IDX] as u16);
           let res = match res  {
              ...
              Err(err) =>   // increase timer interrupt interval to 5 SLOWs 
                    alarm.schedule(SLOW_BLINK_INTERVAL_US * 5),
            }; // match end
	    unsafe {
              IDX +=1;
	      COUNT +=1;
...
//    let led_pin2 = pins.gpio25.into_push_pull_output();
    led_pin.toggle().unwrap();
    delay.delay_ms(500);
    led_pin.toggle().unwrap();
